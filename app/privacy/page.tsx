...
export default function PrivacyPage() {
  return (
    <div className="max-w-prose mx-auto px-4 sm:px-6 lg:px-8 py-16 prose-rtl">
      ...
      <p>
        כשאתם מורידים דף עבודה מהבלוג, אנחנו מקבלים את כתובת המייל שהזנתם ואת שם
        דף העבודה. אם סימנתם שתשמחו לקבל טיפים ועדכונים, נשלח לכם מדי פעם מייל
        כזה, ונרשום שנתתם הסכמה. אם לא סימנתם, לא נשלח לכם דיוור שיווקי. אפשר
        לבקש הסרה בכל רגע, בתשובה לכל מייל או בפנייה אלינו.
      </p>
      <p>
        אנחנו משתמשים במידע הזה אך ורק כדי לחזור אליכם, לנהל את הליווי, ולשלוח
        עדכונים למי שביקש. איננו מוכרים אותו, ואיננו מעבירים אותו לגורמים אחרים
        למטרות שיווק.
      </p>
      ...
      <ul>
        ...
        <li>
          <strong>Web3Forms</strong> — השירות שדרכו טופס יצירת הקשר וטופס
          הורדת דפי העבודה נשלחים לתיבת המייל שלנו. הפרטים עוברים דרך שרתיו
          בדרך אלינו.
        </li>
        <li>
